"use strict";
	...
	var initTable1 = function() {
		...
		// begin first table
		table.DataTable({
			"ajax": "index?action=apiuserlist.js",
			"columns": [
				{ "data": "id" },
				{ "data": "hostname" },
				{ "data": "ipmac" },
			...
			columnDefs: [
				{
					"render": function ( data, type, row ) {
						...
						if(data > 1) {
							return '<div usertime="'+data+'"><span id="remain">'+result+'</span></div>';
						}else{
							return data;
						}							
        ...
        $("#refreshusers").click(function(e) {            
				...
				toastr.success("Sucessfully Refresh Users list","",{"timeOut": "5000","positionClass": "toast-top-right"});  
        });

        $("#gosubmit").click(function (e) {
			
					modeusers = $("#modeusers").val();
                    filterusers = $("#filterusers").val();
                    $.ajax({
                        type: "POST",
                        url: "index?execute=1&exec=filterusers",
                        data: { filterusers: filterusers, modeusers: modeusers },
                        success: function(msg) {
                        if (msg == "1") {
                            toastr.success("Sucessfully Filter Users!", "", {
                                "timeOut": "1000",
     ...
     $("#sendtimetoall").click(function(e) {       
            allminutes = $("#allminutes").val();
			allhours = $("#allhours").val();
			alldays = $("#alldays").val();
            $.ajax({
                type: "POST",
                url: "index?execute=1&exec=sendtimetoall",
                data: {
                ...
                success: function(msg) {
                    if (msg == "1") {
                        toastr.success("Sucessfully Send Time to all users!", "", {
                            "timeOut": "5000",
                            "positionClass": "toast-top-right"
                        });
						location.reload();
      ...
      $("#delete").click(function(e) {       
            ...
            $.ajax({
                type: "POST",
                url: "index?execute=1&exec=delete",
                data: {
                    ipd: ipd                  
                },                
                success: function(msg) {
                    if (msg == "1") {
                        toastr.success("Sucessfully Delete users!", "", {
                            "timeOut": "1000",
                            "positionClass": "toast-top-right"
                        });
						location.reload();
